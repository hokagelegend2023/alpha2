...
touch /var/lib/hokage/data-user-sstp
#detail nama perusahaan
country=ID
state=Indonesia
locality=Jkarta
organization=Hokage
organizationalunit=Legend
commonname=minato.hokagelegend.my.id
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/hokagelegend2023/alpha/main/sstp/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/hokagelegend2023/alpha/main/sstp/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/hokagelegend2023/alpha/main/sstp/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/hokagelegend2023/alpha/main/sstp/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/hokagelegend2023/alpha/main/sstp/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
